...
def submitWMS( args ):
  ...
  job.setExecutable('./mandel4ts/mandelbrot.py',arguments="-P 0.0005 -M 1000 -L %s -N 200 data_%s.bmp" % (first_line, first_line))
                    
  job.setOutputData( ['data_*.bmp','data*.txt'],outputPath='mandelbrot/images/raw')
